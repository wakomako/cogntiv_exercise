...
from siren.baseline.eval import eval_model_interpolation
...
def parse_args():
    ...
    parser.add_argument('--image_encoding', default="continuous", type=ImageEncoding,
                        help='the type of image encoding to train on', choices=["discrete", "continuous"])

    parser.add_argument('--chkpt_path', default=Path(__file__).parent.parent / "checkpoints/interpolate_continuous_epoch_499_loss_0.001428035320714116.chkpt", type=Path,
...
if __name__ == '__main__':
    ...
    eval_model_interpolation(args.chkpt_path, data, sidelength)
    print('end')